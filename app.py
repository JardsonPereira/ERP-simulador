...
# --- FUNÇÕES SUPREMAS DE CÁLCULO CONTÁBIL (MOVIDAS PARA O TOPO) ---
def is_admin():
...
with st.sidebar:
    ...
    # ESTRUTURA BLINDADA DO FORMULÁRIO CONTRA CONFLITOS DE INSTANCIAÇÃO DO STREAMLIT
    with st.form(key=f"form_sidebar_{id_usuario_filtrado}_{st.session_state.form_count}"):
        
        # Estratégia de Seleção Unificada: Evita que o selectbox trave ocultando a digitação
