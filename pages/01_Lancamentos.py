...
with aba2:
    ...
    if dados:
        ...
        # Filtra apenas o que existe no banco
        colunas = ['id', 'operacao', 'valor', 'data_lancamento', 'status_financeiro', 'justificativa']
        df_editavel = df[colunas].copy()
        
        # Limpa dados para o editor não crashar
        df_editavel['valor'] = pd.to_numeric(df_editavel['valor'], errors='coerce').fillna(0)
